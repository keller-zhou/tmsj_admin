...
if($verify_result) {//验证成功
  ...
  $sendUrl = 'http://tmsj.taomiwo.top/login/login/pay.html';
	...
	if($u_id){
		...
		$Url="http://tmsj.taomiwo.top/index/pay/pay_biaoge.html?u_id={$u_id}&money={$_GET['money']}&outtrade={$out_trade_no}";
