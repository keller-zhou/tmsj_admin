<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/banner_admin.html";i:1556680866;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
...
<div class="navbar-custom-menu p-t-10">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link active"  href="<?php echo url('banner/banner_admin'); ?>" ><i class="icon icon-credit-card"></i>待审核</a>
                    </li><li>
                        <a class="nav-link  " href="<?php echo url('banner/banner_admin_ok'); ?>"><i class="icon icon-check-square-o"></i> 审核通过</a>
                    </li><li>
                        <a class="nav-link  " href="<?php echo url('banner/banner_admin_no'); ?>"><i class="icon icon-not_interested"></i> 已拒绝</a>
                    </li></ul>
            </div>
        </div>
    </header>
    ...
    <div class="container-fluid animatedParent animateOnce">
        ...
        <div class="tab-content my-3" >
            ...
            <div class="tab-pane animated fadeInUpShort go  active show"  role="tabpanel" aria-labelledby="v-pills-all-tab">
                 <div class="row">
 				...
 				<!--	 <span class="badge badge-Secondary badge-mini  shadow1" style=" margin-top: 10px; margin-right: 10px; "> <?php echo $vo['sort']; ?> </span>  -->
                              
                                <div class="">                            
                     
                                    <img src="<?php echo $vo['picurl']; ?>" alt="User Image">
                                </div>
                                <div>
                                    <h6 class="p-t-10">标题：  <?php echo $vo['name']; ?>  </h6>
                                  <!--描述  <?php echo $vo['content']; ?> -->
                                  <small style="display: inline-block; white-space: nowrap; width: 100%; overflow: hidden; text-overflow:ellipsis;">跳转地址：<?php echo $vo['linkurl']; ?></small>
                                </div>
                              <br>
							<a href="<?php echo url('banner/banner_pass_yes',['id'=>$vo['id']]); ?>" title="通过" >    <span class="  btn-fab btn-fab-sm btn-primary shadow text-white"  style=" margin-right: 10px; "><i class="icon icon-check"></i>     </span>    </a>
							<a href="<?php echo url('banner/banner_pass_no',['id'=>$vo['id']]); ?>" title="拒绝" >    <span class="  btn-fab btn-fab-sm shadow btn-Danger"><i class="icon icon-not_interested"></i>      </span>    </a>
