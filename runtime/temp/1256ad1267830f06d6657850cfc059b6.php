<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/yhtx/index.html";i:1561628866;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link active"  href="<?php echo url('yhtx/index'); ?>" ><i class="icon icon-credit-card"></i>提现申请</a>
                    </li><li>
                        <a class="nav-link" href="<?php echo url('yhtx/txlog'); ?>"><i class="icon icon-payment"></i> 提现记录</a>
                    </li></ul>
            </div>
        </div>
    </header>
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                          ...
                                          <td>
                                             ...
                                             <a  onclick="look('<?php echo $vo['zfb']; ?>')"> <img src="<?php echo $vo['zfb']; ?>"></a>
                                                </div> -->
                                                <div>
                                                  
                                                  <div>
                                                        <small> <i class="icon-id-card-o text-light-blue"></i> <?php echo $vo['nick_name']; ?></small>
                                                    </div>
                                                  
                                                        <small><?php echo $vo['username']; ?></small>
                                                </div>
                                            </td>
                                            ...
                                            <td> <small><span style="color: #03a9f4;"><?php echo $vo['txje']; ?></span></small></td>

                                            <td> <small><?php echo date("Y-m-d H:i:s",$vo['ctime']); ?></small></td>
                                            <td>
                                                                                          <div>
                                                  
                                                  <div>
                                                        <small> <?php echo $vo['zfb_name']; ?></small>
                                                    </div>
                                                  
                                                        <small> <?php echo $vo['zfb']; ?></small>
                                                </div>    
                                            ...
                                            <td> <small> <?php echo $vo['weichat']; ?></small></td>
                                      <!--                  <td><button class="btn btn-gray" onclick="yhtx('<?php echo !empty($vo['tx']) && $vo['tx']=='1'?'0':'1'; ?>','<?php echo $vo['id']; ?>','<?php echo $vo['username']; ?>','<?php echo $vo['txje']; ?>','<?php echo $vo['zfb']; ?>','<?php echo $vo['weichat']; ?>')"><?php echo !empty($vo['tx']) && $vo['tx']==='1'?'<span style="color: red"> 拒绝支付</span>':'<span style="color: green"> 确定支付</span>'; ?></button></td>
        -->
                                 <td><button class="btn r-3 badge badge-success  " onclick="yhtx('<?php echo !empty($vo['tx']) && $vo['tx']=='1'?'0':'1'; ?>','<?php echo $vo['id']; ?>','<?php echo $vo['nick_name']; ?>','<?php echo $vo['txje']; ?>','<?php echo $vo['zfb']; ?>','<?php echo $vo['weichat']; ?>')"> <i class="icon-done"></i>确认打款</button></td> 
                                 <td><button class="btn r-3 badge badge-Danger " onclick="yhtx('<?php echo !empty($vo['tx']) && $vo['tx']=='3'?'0':'3'; ?>','<?php echo $vo['id']; ?>','<?php echo $vo['nick_name']; ?>','<?php echo $vo['txje']; ?>','<?php echo $vo['zfb']; ?>','<?php echo $vo['weichat']; ?>')"> <i class="icon-close2"></i>驳回</button></td> 
