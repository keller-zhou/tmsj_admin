<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/vip/return_commissionr.html";i:1560074818;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
				   ...
				   <li><a class="nav-link active" href="<?php echo url('vip/return_commissionr'); ?>" role="tab"><i class="icon icon-yoast"></i>返佣设置</a></li>
                      ...
                      <div class="container-fluid my-3">
                          <div class="row clearfix">
                              ...
                              <div class="col-md-7">
                                  <div class="card">
                                      <div class="card-body b-b">
                                          <form class="form-material"  role="form" id="form1" method="post" action="<?php echo url('vip/return_commissionr'); ?>">
                                                      ...
                                                      <div class="col-sm-12">
                                                          <div class="form-group">
                                                              <div class="form-line focused">
                                                                  <input type="number" class="form-control" value=<?php echo $vo['jbday']; ?>  name="jbday" >
                                                              </div>
                                                          </div>
								...
								<hr>   
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['dljba']; ?> name="dljba">
                                                    <label class="form-label">代理升级一级返佣 (上级) </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['dljbb']; ?> name="dljbb">
                                                    <label class="form-label">代理升级二级返佣 (上上级)</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['ckfa']; ?> name="ckfa">
                                                    <label class="form-label">会员升级一级返佣 (上级) </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['ckfb']; ?> name="ckfb">
                                                    <label class="form-label">会员升级二级返佣 (上上级)</label>
                                                </div>
                                            </div>
                                        </div>
								...
								<hr>   
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['dljbc']; ?> name="dljbc">
                                                    <label class="form-label">代理升级一级返佣 (上级)</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['dljbd']; ?> name="dljbd">
                                                    <label class="form-label">代理升级二级返佣 (上上级)</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['ckfc']; ?> name="ckfc">
                                                    <label class="form-label">会员升级一级返佣 (上级)</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
											<div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control"  value=<?php echo $vo['ckfd']; ?> name="ckfd">
                                                    <label class="form-label">会员升级二级返佣 (上上级)</label>
                                                </div>
                                            </div>
                                        </div>
                              ...
                              <div class="col-md-5">
                                  ...
                                  <a class="btn btn-xs btn-primary">佣金提现门槛 </a><br><br>
                                单笔提现金额必须大于该值<br> 
                                                                   

                                 <hr>
                                
                                  <a class="btn btn-xs btn-primary">返佣比例 </a><br><br>
                                返佣比例 1 为 100%<br> <br> 
                                例：<br> 
                                 0.5  ->  返佣 50% <br> 
                                 0.1  ->  返佣 10% <br> 
								...
								<b>代理权限返佣比例（高佣）：</b>获取返佣的账户权限为代理<br> <br>   
								<b>普通用户返佣比例（低佣）：</b>获取返佣的账户权限为普通用户
                                 <hr>
