<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/index/appId.html";i:1558764250;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
				   ...
				   <li><a class="nav-link " href="<?php echo url('/index/index/index'); ?>" role="tab"><i class="icon icon-barometer"></i>仪表盘</a></li>
                  <li class="float-right"><a class="nav-link active"><i class="icon icon-key6"></i> APP key</a></li>
                      ...
                      <div class="container-fluid my-3">
                          <div class="row">
                                                  ...
                                                  <h6>Key </h6>
                                                   ...
                                                   <div class="row clearfix">
                                                      <div class="col-sm-12">
                                                          <div class="form-group">
                                                              <div class="form-line">
                                                                  <input type="text" class="form-control"   value="<?php echo advert('48'); ?>" name="connect_sid"  data-validate="required,minlength[4],maxlength[18]">
                                                              </div>
                                                          </div>
                              ...
                              <div class="col-md-5">
                                  <h3>KEY帮助</h3>
                                  <hr>
                                  <p>联系微信   <a class="btn btn-xs btn-primary">GOX718</a>   获取.</p>
