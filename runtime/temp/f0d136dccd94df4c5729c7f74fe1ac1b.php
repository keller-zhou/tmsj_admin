<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/video/update.html";i:1585807548;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="animated fadeInUpShort go">
          <div class="container-fluid my-3">
            <div class="row">
                <div class="col-md-7 ">
                         <form  role="form" id="form1"  method="post" action="<?php echo url('video/edit'); ?>" enctype="multipart/form-data" >
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
        								  ...
        								  <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">图片</label>
