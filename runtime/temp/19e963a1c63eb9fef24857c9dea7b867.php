<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/banner_admin_ok.html";i:1556681318;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link "  href="<?php echo url('banner/banner_admin'); ?>" ><i class="icon icon-credit-card"></i>待审核</a>
                    </li><li>
                        <a class="nav-link  active" href="<?php echo url('banner/banner_admin_ok'); ?>"><i class="icon icon-check-square-o"></i> 审核通过</a>
                    </li><li>
        ...
        <div class="tab-content my-3" >
            ...
            <div class="tab-pane animated fadeInUpShort go  active show"  role="tabpanel" aria-labelledby="v-pills-all-tab">
 				...
 				<!--	 <span class="badge badge-Secondary badge-mini  shadow1" style=" margin-top: 10px; margin-right: 10px; "> <?php echo $vo['sort']; ?> </span>  -->
                              ...
                              <br>
							<a href="<?php echo url('banner/banner_pass_no',['id'=>$vo['id']]); ?>" title="驳回" >    <span class="  btn-fab btn-fab-sm shadow btn-Danger"><i class="icon icon-repeat"></i>      </span>    </a>
