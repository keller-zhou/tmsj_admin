<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/mn/update.html";i:1559770262;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link "  href="<?php echo url('mn/index'); ?>" ><i class="icon-th-list"></i> 私人影片列表</a>
                    </li>
                    <li>
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="animated fadeInUpShort go">
          <div class="container-fluid my-3">
            <div class="row">
                <div class="col-md-7 ">
                         <form  role="form" id="form1"  method="post" action="<?php echo url('mn/edit'); ?>" enctype="multipart/form-data" >
                        ...
                        <div class="card no-b  no-r">
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">视频标题</label>
                                            <input class="form-control r-0 light s-12 " name="title"   value="<?php echo $data['title']; ?>"  required="required" placeholder="" type="text">
                                          
                                        </div>
                                         
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">图片地址</label>
                                            <input class="form-control r-0 light s-12 " name="img"   value="<?php echo $data['img']; ?>"  required="required" placeholder="" type="text">
                                          
                                        </div>
                                      
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">详情介绍</label>
                                            <input class="form-control r-0 light s-12 " name="content"   value="<?php echo $data['content']; ?>"  required="required" placeholder="" type="text">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input class="form-control r-0 light s-12 " name="type"  value="<?php echo $data['type']; ?>"  required="required" placeholder="" type="text">
                                        </div>
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input class="form-control r-0 light s-12 " name="region"  value="<?php echo $data['region']; ?>"   required="required" placeholder="" type="text">
                                        </div>
                                     ...
                                     <div class="form-group m-0">
                                        <label for="address" class="col-form-label s-12">播放地址</label>
                                        <input type="text" class="form-control r-0 light s-12" name="url" value="<?php echo $data['url']; ?>"   placeholder="">
                                    </div>
                                  ...
                                  <div style=" min-height: 250px; border: 2px solid rgba(0,0,0,.3); background: #fff; padding: 20px 20px; border: 2px dashed #e1e8ee; ">
          				...
          				<div class="col-md-5">
                                  <h3>私人影片 帮助</h3>
                                  <hr>
                                  <p>该目录通过搜索框输入指定的值打开，这个值可以随时在设置中修改 	</p>
                                  <p>资源可以在采集站获取</p>
                                  <p>请勿用于非法用途！</p>
