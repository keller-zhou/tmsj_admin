<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/banner_ok.html";i:1556081522;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link"  href="<?php echo url('banner/banner_switch_admin'); ?>" ><i class="icon icon-credit-card"></i>待审核</a>
                    </li><li>
                        <a class="nav-link active " href="<?php echo url('banner/banner_ok'); ?>"><i class="icon icon-check-square-o"></i> 审核通过</a>
                    </li><li>
                        <a class="nav-link    " href="<?php echo url('banner/banner_no'); ?>"><i class="icon icon-not_interested"></i> 已拒绝</a>
                    </li></ul>
            </div>
        </div>
    </header>
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="tab-content my-3">
          ...
          <div class="sw-container tab-content">
                                     	 ...
                                     	 <form class="validate" method="get" action="<?php echo url('banner/banner_switch_admin'); ?>">
                                           <div class="form-row">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <table class="table table-hover r-0">
                                        ...
                                        <tbody>
                                         ...
                                         <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                          <tr>
										<td> <small><?php echo $vo['id']; ?></small></td>

                                            
                                            
                                       <td> <small><span class="badge badge-light r-3"><?php echo $vo['nick_name']; ?></span></small></td>

                                            <td> <small><span style="color: #03a9f4;"><?php echo $vo['username']; ?></span></small></td>
                                ...
                                ?>
                                       ...
                                       <td> <small><span class="badge badge-light r-3">¥ <?php echo $vo['money']; ?></span></small></td>
                                   
                                      
                                            
                                                                     <td>
                                <a href="/index/user/index/parentid/<?php echo $vo['id']; ?>"><small><span class="badge badge-light r-3"> <?php echo getusercount($vo['id']); ?> </span></small></a>
                            </td>
                            <td>
                                <a  href="/index/vip/index/parentid/<?php echo $vo['id']; ?>"><small><span class="badge badge-light r-3"> <?php echo getvipcount($vo['id']); ?>  </span></small></a>
                            </td>  
                                       ...
                                       <td> <small>    <span class="badge badge-primary r-3 shadow1 "> <i class="blink " style="font-weight:bold"><?php echo $vo['banner_number']; ?></i> </span>  </small></td>
                                            ...
                                            <td> 
                                              <a href="<?php echo url('banner/update_banner_switch_admin',['id'=>$vo['id']]); ?>" title="处理">    <span class="  btn-fab btn-fab-sm shadow btn-success"><i class="icon icon-check"></i>      </span>    </a>
                                            </td>

                                           <td> 
                                			<a onclick="banner_switch_admin_no('<?php echo $vo['id']; ?>')" title="收回" >    <span class="  btn-fab btn-fab-sm shadow btn-Danger"><i class="icon icon-not_interested"></i>      </span>    </a>
             							 </td>  
...
<script>
    function banner_switch_admin_no(id){
        ...
        layer.confirm('您是否删除该数据', {
            ...
            $.ajax({
                'type'  :   'post',
                'url'   :   '<?php echo url("banner/banner_switch_admin_no"); ?>',
                'data'  :   {
                    'id'    :   str
                },
                'dataType'  :   'json',
