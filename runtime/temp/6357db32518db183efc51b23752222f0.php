<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/version/index.html";i:1560075002;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
                        ...
                        <div class="card-body b-b">  
                          ...
                          <div class="card-body b-b">
                            <ul class="list-group">
                             ...
                             <?php  $Ios_Updated_switch  =  db('advert')->where('id = 155')->value('content');   

								if($Ios_Updated_switch == '1'){?> 
                                    
                                                 <a href="<?php echo url('Version/eject_no',['id'=>155]); ?>" title="断开"  class="btn btn-primary btn-xs blink"><i class="icon-phonelink_ring"></i> 更新推送中</a>
                     
                                    <?php } else if($Ios_Updated_switch == '0'){?> 
                                    
                                        
                                                 <a href="<?php echo url('Version/eject_ok',['id'=>155]); ?>" title="推送"  class="btn btn-secondary btn-xs"><i class="icon-phonelink_erase"></i> 已断开 </a>
                             ...
                             <?php  $Android_Updated_switch  =  db('advert')->where('id = 154')->value('content');   

								if($Android_Updated_switch == '1'){?> 
                                    
                                                 <a href="<?php echo url('Version/eject_no',['id'=>154]); ?>" title="断开"  class="btn btn-primary btn-xs blink"><i class="icon-phonelink_ring"></i> 更新推送中</a>
                     
                                    <?php } else if($Android_Updated_switch == '0'){?> 
                                    
                                        
                                                 <a href="<?php echo url('Version/eject_ok',['id'=>154]); ?>" title="推送"  class="btn btn-secondary btn-xs"><i class="icon-phonelink_erase"></i> 已断开 </a>
                          ...
                          <br>
                          <h6>IOS下载地址：         <br>
                            <span style="font-size: 9px;color: #d1d8de;"><?php echo $app_ios_down; ?></span></h6>
                           <br> <h6>安卓APK下载地址：       <br>
                             <span style="font-size: 9px;color: #d1d8de;"><?php echo $app_android_down; ?></span></h6>
                           <br>
                          
                            <form class="form-material"  role="form" id="form1" method="post" action="<?php echo url('Version/index'); ?>">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                          <div class="form-group form-float">
                                                <div class="form-line focused ">
                                                    <input type="text" class="form-control"  value="<?php echo advert('152'); ?>" name="Ios_Updated_version" >
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <div class="form-group form-float">
                                                <div class="form-line focused ">
                                                    <input type="text" class="form-control"  value="<?php echo advert('150'); ?>" name="Android_Updated_version" >
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea2">IOS 更新内容简介</label>
                                    <textarea class="form-control r-0"   name="Ios_Updated_content"  rows="3"><?php echo advert('153'); ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea2">Android 更新内容简介</label>
                                    <textarea class="form-control r-0"  name="Android_Updated_content"  rows="3"><?php echo advert('151'); ?></textarea>
                                </div>
						  ...
						  <div class="col-md-5">
                                  <hr>
                                  <h3>更新帮助</h3>
                                  <p>用户当前使用的版本低于推送的版本将会提示更新.</p>
                                  <p>注意：只有当推送状态为  <span class="btn btn-primary btn-xs blink"><i class="icon-phonelink_ring"></i> 更新推送中</span> 且对应的地址填写后客户端才会检测 .</p>
                            
                            
                            <br> 
                            
                                   对应的下载地址 在 【 仪表盘-设置 】 中编辑
