<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/tv/add.html";i:1585806220;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link "  href="<?php echo url('tv/index'); ?>" ><i class="icon-th-list"></i> 电视TV直播列表</a>
                    </li>
                    <li>
                        <a class="nav-link active" href="<?php echo url('tv/add'); ?>"><i class="icon-add_circle"></i> 添加</a>
                    </li>
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="animated fadeInUpShort go">
          <div class="container-fluid my-3">
            <div class="row">
                <div class="col-md-7 ">
                         <form  role="form" id="form1"  method="post" action="<?php echo url('tv/create'); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">电视台名</label>
                                        ...
                                        <div class="form-group m-0">
                                          ...
                                          <div class="form-group m-0">
                                            ...
                                            <input class="form-control r-0 light s-12 " name="type" required="required" placeholder="0直播1专题" type="text">
                                        </div>                      
