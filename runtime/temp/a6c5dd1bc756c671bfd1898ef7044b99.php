<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/video/index.html";i:1556734820;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
...
<div class="navbar-custom-menu p-t-10">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link active"  href="<?php echo url('video/index'); ?>" ><i class="icon-th-list"></i> 电影推荐列表</a>
                    </li>
                    <li>
                        <a class="nav-link" href="<?php echo url('video/add'); ?>"><i class="icon-add_circle"></i> 添加</a>
                    </li>
  ...
  <div class="container-fluid animatedParent animateOnce">
        <div class="tab-content my-3">
            ...
            <div class="tab-pane animated fadeInUpShort go active " >
                <div class="row">
                    ...
                    <div class="col-md-3 my-3">
                        <div class="card no-b">
                            <div class="card-body text-center p-5">
                                <div class=" mb-3">
                                    <img  style="width: 100%; height: 350px" src="<?php echo $vo['img']; ?>">
                                </div>
                                <div>
                                    <h6 class="p-t-10"> <?php echo $vo['title']; ?></h6>
                            <!---      <?php echo $vo['url']; ?>  -->
                                </div>
                              <br>
                              
                              <a href="<?php echo url('video/update',['id'=>$vo['id']]); ?>" title="编辑" class="btn-fab btn-fab-sm btn-primary shadow text-white" style=" margin-right: 20px; "><i class="icon-pencil"></i></a>
                              
                              <a href="<?php echo url('video/del',['id'=>$vo['id']]); ?>" title="删除" class="btn-fab btn-fab-sm btn-Danger shadow text-white"><i class="icon-close2"></i></a>
