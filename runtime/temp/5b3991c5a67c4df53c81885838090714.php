<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/ojbk.html";i:1555190060;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
...
<div class="navbar-custom-menu p-t-10">
    ...
    <div class="container-fluid pt-5">
        <div class="text-center p-5">
            <i class="icon-check_circle s-64 text-primary"></i>
            <h4 class="my-3"> 操作成功 </h4>
            <p>success</p>
            <a href="<?php echo url('/index/index'); ?>" class="btn btn-primary shadow btn-lg"><i class="icon-barometer mr-2 "></i>仪表盘</a>
        </div>
    </div>
</div>           <!-- 调用index/下的文件 -->
