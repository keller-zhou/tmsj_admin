<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/tv/update.html";i:1559770114;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link "  href="<?php echo url('tv/index'); ?>" ><i class="icon-th-list"></i> 电视TV直播</a>
                    </li>
                    <li>
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="animated fadeInUpShort go">
          <div class="container-fluid my-3">
            <div class="row">
                <div class="col-md-7 ">
                         <form  role="form" id="form1"  method="post" action="<?php echo url('tv/edit'); ?>" enctype="multipart/form-data" >
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">详情</label>
                                            <input class="form-control r-0 light s-12 " name="content"   value="<?php echo $data['content']; ?>"  placeholder="" type="text">
