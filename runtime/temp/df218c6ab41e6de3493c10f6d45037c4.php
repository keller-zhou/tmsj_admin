<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/banner_switch_admin.html";i:1556166002;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link active"  href="<?php echo url('banner/banner_switch_admin'); ?>" ><i class="icon icon-credit-card"></i>待审核</a>
                    </li><li>
                        <a class="nav-link  " href="<?php echo url('banner/banner_ok'); ?>"><i class="icon icon-check-square-o"></i> 审核通过</a>
                    </li><li>
                ...
                <div class="row my-3">
                    <div class="col-md-12">
                      ...
                      <div class="card-body"><div class="card-body tab-pane step-content" style="display: block;">
                        <div class="card-title">广告权限申请待处理列表 </div>
          ...
          <div class="sw-container tab-content">
                            ...
                            <td>
                                <a  href="/index/vip/index/parentid/<?php echo $vo['id']; ?>"><small><span class="badge badge-light r-3"> <?php echo getvipcount($vo['id']); ?>  </span></small></a>
                                            ...
                                            <td> 
                                              <a href="<?php echo url('banner/update_banner_switch_admin',['id'=>$vo['id']]); ?>" title="处理">    <span class="  btn-fab btn-fab-sm shadow btn-Primary"><i class="icon icon-check"></i>      </span>    </a>
                                            </td>

                                           <td> 
                                			<a onclick="banner_switch_admin_no('<?php echo $vo['id']; ?>')" title="拒绝" >    <span class="  btn-fab btn-fab-sm shadow btn-Danger"><i class="icon icon-not_interested"></i>      </span>    </a>
             							 </td>  
