<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/index_vip.html";i:1555187110;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li><a class="nav-link  active show" href="<?php echo url('/index/banner/index_vip'); ?>" ><i class="icon icon-photo2"></i>全网VIP影视</a></li>
				<li><a class="nav-link"  href="<?php echo url('/index/banner/add_vip'); ?>"><i class="icon icon-plus-circle"></i> 添加</a></li>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3 my-3">
 					 ...
 					 <span class="badge badge-Secondary badge-mini  shadow1" style=" margin-top: 10px; margin-right: 10px; "> <?php echo $vo['sort']; ?> </span>
                                ...
                                <div>
                                    <h6 class="p-t-10">  <?php echo $vo['name']; ?>  </h6>
                                  <!--描述  <?php echo $vo['content']; ?> -->
                                  <small style="display: inline-block; white-space: nowrap; width: 100%; overflow: hidden; text-overflow:ellipsis;"><?php echo $vo['linkurl']; ?></small>
                                </div>
                              <br>
                              <a href="<?php echo url('banner/update_vip',['id'=>$vo['id']]); ?>" title="编辑" class="btn-fab btn-fab-sm btn-primary shadow text-white" style=" margin-right: 20px; "><i class="icon-pencil"></i></a>
                              <a href="<?php echo url('banner/del',['id'=>$vo['id']]); ?>" title="删除" class="btn-fab btn-fab-sm btn-Danger shadow text-white"><i class="icon-close2"></i></a>
