<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/banner/banner_no.html";i:1556080536;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        ...
                        <a class="nav-link    active" href="<?php echo url('banner/banner_no'); ?>"><i class="icon icon-not_interested"></i> 已拒绝</a>
                    </li></ul>
            </div>
        </div>
    </header>
                ...
                <div class="row my-3">
                    <div class="col-md-12">
                      ...
                      <div class="card-body"><div class="card-body tab-pane step-content" style="display: block;">
                        <div class="card-title">广告权限 <span class=" btn btn-warning  btn-xs  ">已拒绝</span> 用户列表 </div>
          ...
          <div class="sw-container tab-content">
                            ...
                            <td>
                                <a  href="/index/vip/index/parentid/<?php echo $vo['id']; ?>"><small><span class="badge badge-light r-3"> <?php echo getvipcount($vo['id']); ?>  </span></small></a>
                                            ...
                                            <td> 
                                              <a href="<?php echo url('banner/update_banner_switch_admin',['id'=>$vo['id']]); ?>" title="重新处理">    <span class="  btn-fab btn-fab-sm shadow btn-warning "><i class="icon icon-repeat"></i>      </span>    </a>
                                            </td>
