<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/mn/add.html";i:1559770274;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    ...
                    <li>
                        <a class="nav-link active" href="<?php echo url('mn/add'); ?>"><i class="icon-add_circle"></i> 添加</a>
                    </li>
    ...
    <div class="container-fluid animatedParent animateOnce">
        <div class="animated fadeInUpShort go">
          <div class="container-fluid my-3">
            <div class="row">
                <div class="col-md-7 ">
                         <form  role="form" id="form1"  method="post" action="<?php echo url('mn/create'); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input class="form-control r-0 light s-12 " name="img" required="required" placeholder="" type="text">
                                        </div>
