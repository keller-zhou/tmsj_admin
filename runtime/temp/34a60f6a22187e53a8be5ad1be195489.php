<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/mn/index.html";i:1557877652;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link active"  href="<?php echo url('mn/index'); ?>" ><i class="icon-th-list"></i> 私人影片列表</a>
                    </li>
                    <li>
                        <a class="nav-link" href="<?php echo url('mn/add'); ?>"><i class="icon-add_circle"></i> 添加</a>
                    </li>
                    ...
                    <div class="col-md-3 my-3">
                        <div class="card no-b">
                            ...
                            <!---      <?php echo $vo['url']; ?>  -->
                              ...
                              <a href="<?php echo url('mn/update',['id'=>$vo['id']]); ?>" title="编辑" class="btn-fab btn-fab-sm btn-primary shadow text-white" style=" margin-right: 20px; "><i class="icon-pencil"></i></a>
                              
                              <a href="<?php echo url('mn/del',['id'=>$vo['id']]); ?>" title="删除" class="btn-fab btn-fab-sm btn-Danger shadow text-white"><i class="icon-close2"></i></a>
