<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/yhtx/txlog.html";i:1561628868;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
    ...
    <header class="blue accent-3 relative">
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                ...
                <li>
                        <a class="nav-link"  href="<?php echo url('yhtx/index'); ?>" ><i class="icon icon-credit-card"></i>提现申请</a>
                    </li><li>
                        <a class="nav-link  active" href="<?php echo url('yhtx/txlog'); ?>"><i class="icon icon-payment"></i> 提现记录</a>
                    </li></ul>
            </div>
        </div>
    </header>
                ...
                <div class="row my-3">
                    <div class="col-md-7">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                          ...
                                          <td >
                                                <div>
                                                  ...
                                                  <div>
                                                        <small><?php echo $vo['nickname']; ?></small>
                                                    </div>
                                                  
                                                  
                                                    <small>   <i class="icon-id-card-o text-light-blue"></i> <span style="color: #03a9f4;"> uid:<?php echo $vo['uid']; ?></span>  </small> 
                                            ...
                                            <td> <small><?php echo $vo['weixin']; ?></small></td>
                                            <td> <small><span style="color: #03a9f4;"><?php echo $vo['jine']; ?></span></small></td>

                                            <td> <small><?php echo date("Y-m-d H:i:s",$vo['time']); ?></small></td>
                                            <td>
                                                                                   <div>
                                 ...
                                 <td><?php echo !empty($vo['status']) && $vo['status']==3?'<span class="r-3 badge badge-Danger " > <i class="icon-close2"></i>已驳回</span>':'<span class="r-3 badge badge-success " > <i class="icon-done"></i>已打款</span>'; ?>	 <!--<?php echo !empty($vo['tx']) && $vo['tx']==='1'?' 拒绝支付':'确认打款'; ?> --></td> 
