<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/admin/update.html";i:1558764506;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
				   ...
				   <li><a class="nav-link " href="<?php echo url('admin/index'); ?>" role="tab" ><i class="icon icon-bars"></i>管理员列表</a></li>
                  <li class="float-right"><a class="nav-link active" ><i class="icon icon-plus-circle"></i> 修改信息</a></li>
        ...
        <div class="tab-content pb-3">
                              ...
                              <div class="col-md-7">
                                  <div class="card">
                                      <div class="card-body b-b">
                                          <h4>管理员信息修改</h4><hr><br>
                                          <form class="form-material"  role="form" id="form1" method="post" action="<?php echo url('admin/update'); ?>" >
                                              <!-- Input -->
                                              <div class="body">
                                                  ...
                                                  <div class="row clearfix">
                                                      <div class="col-sm-12">
                                                          <div class="form-group">
                                                              <div class="form-line">
                                                                  <input type="text" class="form-control"  name="name" data-validate="required,minlength[4],maxlength[18]" value="<?php echo $data['username']; ?>" data-message-required="账号必填,长度最小为4个字符,最大为18个字符" placeholder="长度最小为4个字符,最大为18个字符" required>
                                                              </div>
                                                          </div>
                                                  ...
                                                  <h6>密码 </h6>
                                                   ...
                                                   <div class="row clearfix">
                                                      <div class="col-sm-12">
                                                          <div class="form-group">
                                                              <div class="form-line">
                                                                  <input type="password" class="form-control"  id="password" name="password" data-validate="required,minlength[4],maxlength[18]"  data-message-required="密码必填,长度最小为4个字符,最大为18个字符" placeholder="长度最小为4个字符,最大为18个字符" required>
                                                              </div>
                                                          </div>
                                                  ...
                                                  <h6>确认密码 </h6>
                                                   ...
                                                   <div class="row clearfix">
                                                      <div class="col-sm-12">
                                                          <div class="form-group">
                                                              <div class="form-line">
                                                                  <input type="password" class="form-control"  name="_password" data-validate="required,minlength[4],equalTo[#password],maxlength[18]" data-message-required="确认密码必填,长度最小为4个字符,最大为18个字符,并与密码一致" placeholder="长度最小为4个字符,最大为18个字符,并与密码一致" >
                                                              </div>
                                                          </div>
            ...
            <INPUT type="hidden" name="page" value="<?php echo $page; ?>">
                              ...
                              <div class="col-md-5">
                                  <h3>管理员帮助</h3>
                                  <hr>
                                  <p>新增管理员仅做辅助管理<br>一切操作还是以ID为1的超级管理员为主</p>
