<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/tv/index.html";i:1556854610;s:62:"/www/wwwroot/tmsj.taomiwo.top/application/index/view/layout.html";i:1559768984;}*/ ?>
<html iTM="Ryan">
  <head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" >
                    <li>
                        <a class="nav-link active"  href="<?php echo url('tv/index'); ?>" ><i class="icon-th-list"></i> 电视TV直播列表</a>
                    </li>
                    <li>
                        <a class="nav-link" href="<?php echo url('tv/add'); ?>"><i class="icon-add_circle"></i> 添加</a>
                    </li>
                    ...
                    <div class="col-md-3 my-3">
                        <div class="card no-b">
                            ...
                            <!---      <?php echo $vo['url']; ?>  -->
                              ...
                              <a href="<?php echo url('tv/update',['id'=>$vo['id']]); ?>" title="编辑" class="btn-fab btn-fab-sm btn-primary shadow text-white" style=" margin-right: 20px; "><i class="icon-pencil"></i></a>
                              
                              <a href="<?php echo url('tv/del',['id'=>$vo['id']]); ?>" title="删除" class="btn-fab btn-fab-sm btn-Danger shadow text-white"><i class="icon-close2"></i></a>
