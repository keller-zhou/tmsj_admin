<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/tmsj.taomiwo.top/application/login/view/login/ikmovie.html";i:1559650198;}*/ ?>
<!DOCTYPE html>
<html iTM="Ryan">
<head>
    <meta charset="utf-8">
...
*/
                            $.ajax({
                                url: "<?php echo url('login/login/pc_veify'); ?>",
                                method: 'POST',
                                dataType: 'json',
                                data: {
                                    do_login: true,
                                ...
                                success: function(resp)
                                {
                                    if(resp.code=='1')
                                    {
                                        ...
                                        $('#alert').html('<span style="color: #f00">账号密码错误或无权限!</span>')
                                    }
...
<div class="page parallel">
    <div class="d-flex row">
        <div class="col-md-3 white">
            ...
            <div class="p-5">
                <h3>管理中心</h3>
                <p  id="alert">The future belongs to industrious people.</p>
                <form method="post" role="form" id="login" >
                    <div class="form-group has-icon"><i class="icon-user-secret"></i>
                        <input type="text"  name="username" id="username" class="form-control form-control-lg" placeholder="User">
                    </div>
                    <div class="form-group has-icon"><i class="icon-lock"></i>
                        <input type="password" name="passwd" id="passwd" class="form-control form-control-lg" placeholder="Password">
                    </div>
        ...
        <div class="col-md-9  height-full blue accent-3 align-self-center text-center" data-bg-repeat="false"
             ...
             style="background: url('<?php echo $Ryan_login_picture; ?>') #FFEFE4">
        </div>
    </div>
</div>
<!-- Right Sidebar -->
